...
Error: Cannot find the native Koffi module; did you bundle it correctly?
    at init (/data/data/dev.koda/files/usr/lib/node_modules/openclaw/node_modules/koffi/index.js:502:15)
    at Object.<anonymous> (/data/data/dev.koda/files/usr/lib/node_modules/openclaw/node_modules/koffi/index.js:636:12)
```
...
```bash
# 备份原文件
cp /data/data/dev.koda/files/usr/lib/node_modules/openclaw/node_modules/koffi/index.js \
   /data/data/dev.koda/files/usr/lib/node_modules/openclaw/node_modules/koffi/index.js.orig

# 写入 mock 模块
cat > /data/data/dev.koda/files/usr/lib/node_modules/openclaw/node_modules/koffi/index.js << 'EOF'
