#!/data/data/dev.koda/files/usr/bin/bash
# fix-koffi.sh - Replace koffi native module with mock for Android/Termux
#
# koffi doesn't ship a prebuilt binary for android_arm64, causing openclaude
...
KOFFI_DIR="/data/data/dev.koda/files/usr/lib/node_modules/openclaude/node_modules/koffi"
