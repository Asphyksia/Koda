...
/**
 * Step 2 of setup: Welcome + Auto-install OpenClaude
 *
...
public class InstallFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_koda_install, container, false);
    ...
    private void startInstallation() {
        ...
        Logger.logInfo(LOG_TAG, "Starting OpenClaude installation");
        ...
        mService.installOpenclaude(new KodaService.InstallProgressCallback() {
            ...
            public void onComplete() {
                ...
                if (version != null) {
                    mStatusMessage.setText(getString(R.string.koda_installation_complete_with_version, version));
                } else {
                    mStatusMessage.setText(getString(R.string.koda_installation_complete));
                }
                ...
                prefetchModelList(version, () -> {
                    ...
                    mStatusMessage.setText(getString(R.string.koda_preparing_next_step));
    ...
    private void prefetchModelList(String openclaudeVersion, ModelListPrefetchCallback callback) {
        ...
        final String normalizedVersion = normalizeCacheKey(openclaudeVersion);
        if (!TextUtils.isEmpty(normalizedVersion) && hasCachedModelList(normalizedVersion)) {
            Logger.logInfo(LOG_TAG, "Using cached model list for OpenClaude v" + openclaudeVersion);
            if (callback != null) {
                callback.onFinished();
            }
            return;
    ...
    private void showError(String error) {
        ...
        mStatusMessage.setText(getString(R.string.koda_installation_failed));
    }
    ...
    private void resetSteps() {
        ...
        mStatusMessage.setText(getString(R.string.koda_takes_about_a_minute));
