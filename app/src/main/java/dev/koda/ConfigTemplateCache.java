...
public class ConfigTemplateCache {
    ...
    private static final String PREFS_NAME = "koda_config_template";
    ...
    /**
     * Apply template to OpenClaude configuration files.
    ...
    public static boolean applyTemplate(Context ctx, ConfigTemplate template) {
        ...
        try {
            ...
            boolean success = KodaConfig.setProvider(
                template.provider,
                modelName,
                template.baseUrl,
