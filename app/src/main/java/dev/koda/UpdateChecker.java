...
/**
 * Lightweight version checker that queries the Koda API for the latest release.
...
public class UpdateChecker {
    ...
    private static final String CHECK_URL = "https://api.koda.app/version";
    private static final long CHECK_INTERVAL_MS = 6 * 60 * 60 * 1000L; // 6 hours
    private static final int CONNECT_TIMEOUT_MS = 10000;
    private static final int READ_TIMEOUT_MS = 10000;
    private static final String PREFS_NAME = "koda_update";
    ...
    static boolean isUpdateManagementDisabled(Context ctx) {
        return BundledOpenclaudeUtils.shouldDisableUpdateManagement(ctx);
    }
