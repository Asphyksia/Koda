...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void addProviderCard(ProviderManager.Provider provider, boolean isActive) {
        ...
        if (isActive) {
            ...
            bg.setStroke(dp(1), ContextCompat.getColor(this, R.color.koda_stroke));
        }
        ...
        keyStatus.setTextColor(hasKey
            ? ContextCompat.getColor(this, R.color.koda_success)
            : ContextCompat.getColor(this, R.color.koda_warning));
        ...
        if (!isActive) {
            addCardButton(buttons, "Use",
                ContextCompat.getColor(this, R.color.koda_on_primary),
                ContextCompat.getColor(this, R.color.koda_primary),
                v -> {
        ...
        addCardButton(buttons, "Edit",
            ContextCompat.getColor(this, R.color.koda_text_secondary),
            ContextCompat.getColor(this, R.color.koda_surface_3),
            v -> showEditProviderDialog(provider));

        card.addView(buttons);
        mContainer.addView(card);
    }

    private void addCardButton(LinearLayout parent, String text, int textColor, int bgColor,
    ...
    private void showEditProviderDialog(ProviderManager.Provider provider) {
        ...
        EditText nameInput = addFormInput(form, provider.name, "e.g. RelayGPU", InputType.TYPE_CLASS_TEXT);
        addFormLabel(form, "Base URL");
        EditText urlInput = addFormInput(form, provider.baseUrl, "https://api.anthropic.com", InputType.TYPE_TEXT_VARIATION_URI);
        addFormLabel(form, "API Key");
        EditText keyInput = addFormInput(form, provider.apiKey, "sk-...", InputType.TYPE_TEXT_VARIATION_PASSWORD);
        addFormLabel(form, "Default Model");
        EditText modelInput = addFormInput(form, provider.defaultModel, "claude-sonnet-4-6", InputType.TYPE_CLASS_TEXT);
    ...
    private void showAddProviderDialog() {
        ...
        addFormLabel(form, "Name");
        EditText nameInput = addFormInput(form, "", "e.g. My Provider", InputType.TYPE_CLASS_TEXT);
        addFormLabel(form, "Base URL");
        EditText urlInput = addFormInput(form, "", "https://api.example.com", InputType.TYPE_TEXT_VARIATION_URI);
        addFormLabel(form, "API Key");
        EditText keyInput = addFormInput(form, "", "sk-...", InputType.TYPE_TEXT_VARIATION_PASSWORD);
        addFormLabel(form, "Default Model");
        EditText modelInput = addFormInput(form, "", "claude-sonnet-4-6", InputType.TYPE_CLASS_TEXT);
    ...
    private EditText addFormInput(LinearLayout parent, String value, String hint, int inputType) {
