...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // New chat buttons
        View.OnClickListener newChatClick = v -> startNewConversation();
        ...
        View.OnClickListener settingsClick = v -> startActivity(new Intent(this, SettingsActivity.class));
        View settingsBtn = findViewById(R.id.drawer_settings);
        View settingsLabel = findViewById(R.id.drawer_settings_label);
        if (settingsBtn != null) settingsBtn.setOnClickListener(settingsClick);
        if (settingsLabel != null) settingsLabel.setOnClickListener(settingsClick);
    ...
    private void sendMessage() {
        ...
        mService.sendToOpenClaude(message, mSessionId, systemPrompt, new KodaService.StreamCallback() {
            ...
            public void onUsage(int inputTokens, int outputTokens, double costUsd) {
                // Captured for future stats screen — not shown per-message
            }
