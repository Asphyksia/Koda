...
/**
 * Helper class for reading and writing OpenClaude configuration.
 * Handles openclaude.json at ~/.openclaude/openclaude.json
 *
 * Thread-safe: All file operations are synchronized.
 */
public class KodaConfig {

    private static final String LOG_TAG = "KodaConfig";
    private static final String CONFIG_DIR = TermuxConstants.TERMUX_HOME_DIR_PATH + "/.openclaude";
    private static final String CONFIG_FILE = CONFIG_DIR + "/openclaude.json";
     ...
     *
     * - Default providers: set provider/model in openclaude.json + write API key.
     ...
     * openclaude.json so OpenClaude can resolve selected model ids.
     *
     ...
     * Writes to ~/.openclaude/agents/main/agent/auth-profiles.json
     */
                ...
                if (channels != null) {
                    ...
                    if (telegram != null) {
                        ...
                        if (network != null) {
                            ...
                            // Koda prefers forcing IPv4 via NODE_OPTIONS; leaving OpenClaude's
    ...
    /**
     * Normalize provider model entries to match OpenClaude schema used by OpenClaude:
