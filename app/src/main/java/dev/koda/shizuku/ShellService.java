...
public class ShellService extends Service {
    ...
    private static final String FALLBACK_SHARED_ROOT = "/data/local/tmp/koda_tmp";
    private static final String FALLBACK_TERMUX_HOME = "/data/data/dev.koda/files/home";
    ...
    private String ensureTermuxEnvironment(String command) {
        ...
        return "export KODA_SHARED_ROOT=" + quotedRoot
            + "; export KODA_TERMUX_HOME=" + quotedHome
    ...
    private String resolveSharedRoot() {
        final String[] candidates = new String[]{
            System.getenv("KODA_SHARED_ROOT"),
            "/data/local/tmp/koda_tmp",
    ...
    private String resolveTermuxHome() {
        final String[] candidates = new String[]{
            System.getenv("KODA_TERMUX_HOME"),
