...
public class ShizukuStatusActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_AUTO_START = "dev.koda.extra.AUTO_START_SHIZUKU";
    public static final String EXTRA_AUTO_REQUEST_PERMISSION = "dev.koda.extra.AUTO_REQUEST_SHIZUKU_PERMISSION";
