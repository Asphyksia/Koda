...
/**
 * Unit tests for KodaConfig
 *
 * Note: KodaConfig uses hardcoded paths from TermuxConstants which point to
 * /data/data/com.termux/files/home/.openclaude/openclaude.json
 *
...
@Config(sdk = 28)
public class KodaConfigTest {

    private static final String TEST_CONFIG_DIR = System.getProperty("java.io.tmpdir") + "/test-openclaude";
    private static final String TEST_CONFIG_FILE = TEST_CONFIG_DIR + "/openclaude.json";
     ...
     * because KodaConfig.readConfig() uses hardcoded Termux paths.
    ...
    public void testSetProvider_createsCorrectStructure() {
        ...
        boolean result = KodaConfig.setProvider("anthropic", "claude-sonnet-4-5");
    ...
    public void testSetProvider_withNullValues_handlesGracefully() {
        ...
        try {
            boolean result = KodaConfig.setProvider(null, null);
    ...
    public void testSetApiKey_withNonExistentPaths_handlesGracefully() {
        ...
        boolean result = KodaConfig.setApiKey("anthropic", "test-key-123");
    ...
    public void testIsConfigured_noConfig_returnsFalse() {
        boolean configured = KodaConfig.isConfigured();
    ...
    public void testExpectedConfigStructure() throws JSONException {
        ...
        auth.put("token", "koda-local-token");
