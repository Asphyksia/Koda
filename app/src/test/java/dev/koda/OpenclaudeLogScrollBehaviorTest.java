...
@Config(sdk = 28)
public class OpenclaudeLogScrollBehaviorTest {
    ...
    public void bind_whenScrolledToBottom_keepsViewNearBottomAfterRefresh() throws Exception {
        ...
        View pageView = LayoutInflater.from(activity).inflate(R.layout.item_openclaude_log_page, null, false);
        activity.setContentView(pageView);
        ScrollView scrollView = (ScrollView) pageView;
        TextView textView = pageView.findViewById(R.id.openclaude_log_page_text);
    ...
    private Object createCurrentProductionHolder(View pageView) throws Exception {
        Class<?> holderClass = Class.forName("dev.koda.DashboardActivity$OpenclaudeLogPageViewHolder");
