...
public class StepPercentUtilsTest {
    ...
    public void stripTrailingPercentTextRemovesSuffixOnly() {
        assertEquals("Installing OpenClaude", StepPercentUtils.stripTrailingPercentText("Installing OpenClaude 68%"));
        assertEquals("Installing OpenClaude", StepPercentUtils.stripTrailingPercentText("Installing OpenClaude"));
    }
}
