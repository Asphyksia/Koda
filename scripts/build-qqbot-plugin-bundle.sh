...
DEFAULT_OUTPUT_ROOT="$ROOT_DIR/build/openclaude-bundles"
...
main() {
  ...
  [[ -f "$staged_root/package/openclaude.plugin.json" ]] || fail "missing openclaude.plugin.json"
