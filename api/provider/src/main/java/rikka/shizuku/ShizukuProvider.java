...
public class ShizukuProvider extends ContentProvider {
    ...
    public static final String ACTION_BINDER_RECEIVED = "dev.koda.api.action.BINDER_RECEIVED";

    public static final String EXTRA_BINDER = "dev.koda.intent.extra.BINDER";

    public static final String PERMISSION = "dev.koda.permission.API_V23";

    public static final String MANAGER_APPLICATION_ID = "dev.koda";
